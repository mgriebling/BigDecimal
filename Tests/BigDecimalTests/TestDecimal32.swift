...
class TestDecimal32: XCTestCase {
    ...
    let tests1: [test] = [
        ...
        test("1.1123450", "1.112345", .halfDown),
        test("1.11234549", "1.112345", .halfDown),
        test("1.11234550", "1.112345", .halfDown),
        test("1.11234650", "1.112346", .halfDown),
        test("1.11234551", "1.112346", .halfDown),
        test("1.1123450", "1.112345", .halfEven),
        test("1.11234549", "1.112345", .halfEven),
        test("1.11234550", "1.112346", .halfEven),
        test("1.11234650", "1.112346", .halfEven),
        test("1.11234551", "1.112346", .halfEven),
        test("1.1123450", "1.112345", .halfUp),
        test("1.11234549", "1.112345", .halfUp),
        test("1.11234550", "1.112346", .halfUp),
        test("1.11234650", "1.112347", .halfUp),
        test("1.11234551", "1.112346", .halfUp),
        test("-1.1123450", "-1.112345", .ceiling),
