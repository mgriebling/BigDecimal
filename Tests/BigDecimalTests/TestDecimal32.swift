...
class TestDecimal32: XCTestCase {
    ...
    let tests1: [test] = [
        test("1.1123450", "1.112345", .CEILING),
        test("1.11234549", "1.112346", .CEILING),
        test("1.11234550", "1.112346", .CEILING),
        test("1.11234551", "1.112346", .CEILING),
        test("1.1123450", "1.112345", .UP),
        test("1.11234549", "1.112346", .UP),
        test("1.11234550", "1.112346", .UP),
        test("1.11234551", "1.112346", .UP),
        test("1.1123450", "1.112345", .FLOOR),
        test("1.11234549", "1.112345", .FLOOR),
        test("1.11234550", "1.112345", .FLOOR),
        test("1.11234551", "1.112345", .FLOOR),
        test("1.1123450", "1.112345", .DOWN),
        test("1.11234549", "1.112345", .DOWN),
        test("1.11234550", "1.112345", .DOWN),
        test("1.11234551", "1.112345", .DOWN),
        test("1.1123450", "1.112345", .HALF_DOWN),
        test("1.11234549", "1.112345", .HALF_DOWN),
        test("1.11234550", "1.112345", .HALF_DOWN),
        test("1.11234650", "1.112346", .HALF_DOWN),
        test("1.11234551", "1.112346", .HALF_DOWN),
        test("1.1123450", "1.112345", .HALF_EVEN),
        test("1.11234549", "1.112345", .HALF_EVEN),
        test("1.11234550", "1.112346", .HALF_EVEN),
        test("1.11234650", "1.112346", .HALF_EVEN),
        test("1.11234551", "1.112346", .HALF_EVEN),
        test("1.1123450", "1.112345", .HALF_UP),
        test("1.11234549", "1.112345", .HALF_UP),
        test("1.11234550", "1.112346", .HALF_UP),
        test("1.11234650", "1.112347", .HALF_UP),
        test("1.11234551", "1.112346", .HALF_UP),
        test("-1.1123450", "-1.112345", .CEILING),
        test("-1.11234549", "-1.112345", .CEILING),
        test("-1.11234550", "-1.112345", .CEILING),
        test("-1.11234551", "-1.112345", .CEILING),
        test("-1.1123450", "-1.112345", .UP),
        test("-1.11234549", "-1.112346", .UP),
        test("-1.11234550", "-1.112346", .UP),
        test("-1.11234551", "-1.112346", .UP),
        test("-1.1123450", "-1.112345", .FLOOR),
        test("-1.11234549", "-1.112346", .FLOOR),
        test("-1.11234550", "-1.112346", .FLOOR),
        test("-1.11234551", "-1.112346", .FLOOR),
        test("-1.1123450", "-1.112345", .DOWN),
        test("-1.11234549", "-1.112345", .DOWN),
        test("-1.11234550", "-1.112345", .DOWN),
        test("-1.11234551", "-1.112345", .DOWN),
