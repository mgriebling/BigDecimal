...
extension BigDecimal {
    ...
    /// For example: BigDecimal("56.7") & BigDecimal("89.13") = 24
    ...
    /// Arguments will be converted to integral numbers using truncation
    /// and the result will also be an integral number
    /// For example: BigDecimal("56.7") | BigDecimal("89.13") = 121
    public static func | (lhs:Self, rhs:Self) -> Self { doLogic(lhs, |, rhs) }
    ...
    /// Arguments will be converted to integral numbers using truncation
    /// and the result will also be an integral number
    /// For example: BigDecimal("56.7") ^ BigDecimal("89.13") = 97
    public static func ^ (lhs:Self, rhs:Self) -> Self { doLogic(lhs, ^, rhs) }
    ...
    /// Arguments will be converted to integral numbers using truncation
    /// and the result will also be an integral number
    /// For example: ~BigDecimal("56.7") = -57
    ...
    /// Arguments will be converted to integral numbers using truncation
    /// and the result will also be an integral number
    /// For example: nand(BigDecimal("56.7"), BigDecimal("89.13")) = 7
    ...
    /// Arguments will be converted to integral numbers using truncation
    /// and the result will also be an integral number
    /// For example: nor(BigDecimal("56.7"), BigDecimal("89.13")) = 902
    ...
    /// Arguments will be converted to integral numbers using truncation
    /// and the result will also be an integral number
    /// For example: xnor(BigDecimal("56.7"), BigDecimal("89.13")) = 926
