...
1. Much of the original `BigDecimal` (pre-V2) was created by Leif Ibsen - https://github.com/leif-ibsen/BigDecimal.git
2. Some unit test cases come from General Decimal Arithmetic - http://speleotrove.com/decimal
